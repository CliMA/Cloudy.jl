...
plot_moments_and_params!(sol, ODE_parameters; file_name="examples/single_particle_gam_params.png")
plot_moments!(sol, ODE_parameters; file_name="examples/single_particle_gam_moments.png")
plot_spectra!(sol, ODE_parameters; file_name="examples/single_particle_gam_spectra.png")
