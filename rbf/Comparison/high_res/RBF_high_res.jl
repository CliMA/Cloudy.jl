"Golovin coalescence kernel example at high resolution"
...
function main()
  ...
  ############################### PLOTTING ####################################
    ...
    savefig("rbf/Comparison/highres20_noforcing_dist.png")
  ...
  savefig("rbf/Comparison/highres20_noforcing.png")
  ...
  println("Normalized initial constants: ", c0/sum(c0))
  println("Normalized final constants: ", cj/sum(cj))
