...
# Initial condition
moment_init = [100.0, 10.0, 2, 0.0, 0, 0, 0.0, 0, 0]
dist_init = [
...
ODE_parameters = (; pdists = deepcopy(dist_init), coal_data = coal_data, NProgMoms = NProgMoms, dt = FT(1))
...
plot_spectra!(sol, ODE_parameters; file_name = "box_gamma_mixture_3modes_spectra.pdf", logxrange = (-3, 6))
