...
ODE_parameters = (; pdists = dist_init, coal_data = coal_data, NProgMoms = NProgMoms, dt = FT(1.0))
...
plot_spectra!(sol, ODE_parameters; file_name = "box_gamma_mix_long_spectra.pdf", logxrange = (-2, 5))
