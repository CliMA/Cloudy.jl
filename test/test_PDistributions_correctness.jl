"Testing correctness of PDistributions module."

using SpecialFunctions: gamma, gamma_inc
using Cloudy.PDistributions

import Cloudy.PDistributions: nparams, get_params, update_params,
...
@test typeof(dist.subdists) == Array{PDistribution{FT}, 1}
